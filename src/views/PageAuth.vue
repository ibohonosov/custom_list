...
const subtitleText = computed<string>(() => {
  return isLogin.value ? "Aккаунта ещё нет?" : 'Уже есть аккаунт?'
})
...
<template>
  ...
  <div class="flex justify-center p-2">
    <div class="bg-surface p-4 shadow-lg rounded w-full lg:w-1/2">
      <div class="text-center mb-3">
        <div class="text-surface-0 text-3xl font-medium mb-3 ">Приветствую!</div>
        <span class="text-surface-300 font-medium line-height-3">{{ subtitleText }}</span>
